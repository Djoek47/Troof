      ...
      <div className="max-w-4xl mx-auto">
        <Card className="bg-white shadow-lg border-0 rounded-3xl">
          ...
          <CardContent className="px-8 pb-12 space-y-8">
            ...
            {/* Terms Sections */}
            <section>
              <h2 className="text-2xl font-light text-gray-900 mb-4 tracking-tight">Order Acceptance</h2>
            ...
            <section>
              <h2 className="text-2xl font-light text-gray-900 mb-4 tracking-tight">All Sales Final</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-light text-gray-900 mb-4 tracking-tight">Order Processing</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-light text-gray-900 mb-4 tracking-tight">Shipping and Delivery</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-light text-gray-900 mb-4 tracking-tight">Product Quality</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <div className="bg-gray-50 rounded-xl p-4 mt-3">
                <p className="text-gray-700">
                  <strong>Email:</strong> support@faberstore.com
                </p>
              </div>
            </section>
